...
class ReminderListFragmentTest : AutoCloseKoinTest() {// Extended Koin Test - embed autoclose @after method to close Koin after every test
    ...
    fun reminderList_DisplayedInUI() {
        ...
        runBlocking {
            //Given - add a reminder to the db
    ...
    @Test
    fun reminderList_clickAddButton_navigateToSaveRemindersFragment(){
        ...
        //Then - verify that we navigate to the save reminders fragment screen
